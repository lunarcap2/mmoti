...
<!--삭제-->
<!--#include virtual = "/my/resume/inc_resume_item_delete.asp"-->

<!--임시저장, 저장, 수정-->
<!--#include virtual = "/my/resume/inc_resume_item_insert.asp"-->
	
<%
Dim move_url, msg

If rsubGubun = "1" Or rsubGubun = "4" Or rsubGubun = "5" Or rsubGubun = "13" Then
	move_url = "/my/resume/rsub_regist.asp"
Else
	move_url = "/my/resume/rsub_view.asp"
End If
